  ...
  return (
    ...
    >
      ...
      <div className="max-w-[90%] w-[1200px] text-darkBlue  mx-auto  py-12 tablet:py-24 tablet:pb-48 bg-white flex flex-col gap-8">
        ...
        <div className="grid tablet:grid-cols-3 gap-6 mt-6 z-[3]">
          {teamFoodData.map((data, i) => {
            return (
              <div key={i} className="relative">
                <img src={data.img} alt="team" />

                <div className="absolute right-6 left-6 -bottom-12 shadow-lg flex items-center justify-between gap-6 bg-white p-8 px-6 rounded-3xl">
                  <div>
                    <h2
